    ...
    public partial class BasecodeData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Enrollee_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UID = table.Column<int>(type: "int", nullable: false),
                    CGM = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    BirthCertificate = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    TOR = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewEnrollee", x => x.Enrollee_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersPortal", x => x.UID);
                });
